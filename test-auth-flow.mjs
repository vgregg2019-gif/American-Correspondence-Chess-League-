...
const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://wksfkmecrqwnovjybbna.supabase.co';
const SUPABASE_ANON_KEY = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Indrc2ZrbWVjcnF3bm92anliYm5hIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQxOTY4NjUsImV4cCI6MjA4OTc3Mjg2NX0.-6qrIhGTOJiAsZit7EneFcUBOdEew3YN0gMz9PouxnA';
